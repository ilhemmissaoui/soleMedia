  ...
  return (
    <>
      ...
      <div className="contact-details-wrap">
        ...
        >
          {/* Tunisia Map */}
          <section style={{ flex: "1 1 48%" }} aria-labelledby="tunisia-map">
            <h3 id="tunisia-map" className="visually-hidden">
              Tunisia Office Map
            </h3>
            <iframe
              title="Sole Digital Media Tunisia Office Location"
          ...
          {/* Canada Map */}
          <section style={{ flex: "1 1 48%" }} aria-labelledby="canada-map">
            <h3 id="canada-map" className="visually-hidden">
              Canada Office Map
            </h3>
            <iframe
              title="Sole Digital Media Canada Office Location"
