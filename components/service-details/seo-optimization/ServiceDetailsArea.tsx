          ...
          <div className="row g-4 g-xxl-5">
            <div className="col-12 col-lg-8">
              <div className="service-details-content">
                <img className="rounded-lg" src="/assets/img/seo1.jpg" loading="lazy" />
                <h2>
                ...
                <div className="row g-4">
                  <div className="col-6">
                    <img src="/assets/img/seo3.jpg" loading="lazy" />
                  </div>
                  <div className="col-6">
                    <img src="/assets/img/digital-marketing.jpg" loading="lazy" />
                  </div>
                </div>
              </div>
